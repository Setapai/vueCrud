    ...
    <div class="container mx-auto h-screen font-poppins">
        <div class="flex flex-col-reverse sm:flex-row h-full items-center justify-around ">
            <div id="rightBox" class="space-y-4 w-2/4 p-16 inline-flex flex-col text-slate-600 text-center sm:text-left ">
                <h1 class="text-4xl">Inventory CRUD</h1>
                <h1 class="text-md">Create, Read, Update and Delete</h1>
                <p class="text-2xl ">
                    The Technology Being used for this project are <br>
                    <b>
                        <i>
                            <iconComponent class="p-4" text="Vue" :style="{ backgroundImage: 'url(' + image[0] + ')' }" />
            ...
            <div id="leftBox" class="w-2/4 p-5 flex flex-col space-y-5 ">
                ...
                <form class="flex flex-col space-y-5" action="" method="post">
                    <inputComponent class="text-center" placeholder="Username" type="text" name="uname" tabindex="1" />
                    <inputComponent class="text-center" placeholder="Password" type="password" name="pword" tabindex="2" />
                    <div class="flex flex-col items-end space-y-3">
                        ...
                        <a href="#shiz"
                            class="cursor-pointer rounded bg-white p-3 shadow-lg focus:shadow-inner focus:bg-gray-100 hover:shadow-inner outline-none"
                            tabindex="5">
                            <iconComponent class="p-5" text2="Login Using Google"
